...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-full border border-transparent dark:bg-black dark:border-white/[0.2] bg-[#233831b3] shadow-input flex justify-evenly space-x-4  py-3 md:text-xl  "
    >
      {children}
    </nav>
  );
